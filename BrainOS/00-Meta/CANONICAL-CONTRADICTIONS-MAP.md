...
| `BrainOS/90-Archive/02-Legacy-Methodology/METHODOLOGY-MASTER.md` | Convive visión de evolución amplia sin checklist operativo de validación | parcial | Se archivó como legado; baseline operativo consolidado en documento canónico + referencia al playbook | La fuente operativa v0.1 es el playbook de validación |
